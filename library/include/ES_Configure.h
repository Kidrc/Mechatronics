...
EVENT(FOUND_BEACON)\
EVENT(START_SEARCH)\
EVENT(RETURN_HOME_CASTLE)\
EVENT(CHECK_TW_COMPLETE)\
EVENT(START_ROTATE)\
...
#define EVENT_CHECK_LIST  CheckBumpers, CheckTapes, CheckTrackwire, CheckBeacon
...
#define TIMER4_RESP_FUNC PostAlignFSM
#define TIMER5_RESP_FUNC PostAlignFSM
#define TIMER6_RESP_FUNC PostReturnCenterFSM
#define TIMER7_RESP_FUNC PostSearchCastleFSM
#define TIMER8_RESP_FUNC PostRotateFSM
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "toplevel.h"
// the name of the Init function
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "AlignReverse.h"
// the name of the Init function
#define SERV_3_INIT ALIGN_REVERSE_InitFSM
// the name of the run function
#define SERV_3_RUN ALIGN_REVERSE_RunFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "ReturnCenter.h"
// the name of the Init function
#define SERV_4_INIT RETURN_CENTER_InitFSM
// the name of the run function
#define SERV_4_RUN RETURN_CENTER_RunFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "SearchCastle.h"
// the name of the Init function
#define SERV_5_INIT SEARCH_CASTLE_InitFSM
// the name of the run function
#define SERV_5_RUN SEARCH_CASTLE_RunFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public fuction prototypes
#define SERV_6_HEADER "Rotate.h"
// the name of the Init function
#define SERV_6_INIT ROTATE_InitFSM
// the name of the run function
#define SERV_6_RUN ROTATE_RunFSM
// How big should this services Queue be?
